    ...
    >
      <div className="flex h-full flex-col items-start justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          <span className="flex -space-x-4 overflew-hidden">
            {PEOPLE_URL.map((url) => (
              <Image
                src={url}
                key={url}
...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:py-20 xl:mb-20">
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:rm-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <p className="regular-14 xl:regular-16 mt-5 text-white">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci alias blanditiis, labore doloribus eum optio incidunt quas odio, dignissimos reprehenderit minus inventore, impedit officia voluptas?
          </p>
